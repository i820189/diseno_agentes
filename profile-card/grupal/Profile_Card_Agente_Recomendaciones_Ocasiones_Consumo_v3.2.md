...
El agente consulta el sistema donde se registra la disponibilidad real de las alternativas para la fecha solicitada.

Las opciones no disponibles deben descartarse. Si el sistema no responde, el agente debe indicar que no puede confirmar la disponibilidad y ofrecer la derivación a un asesor.

### Conexión con precios y cotizaciones

El agente se conecta al sistema oficial de precios para obtener el importe vigente, impuestos, condiciones, fecha de validez y total de la cotización.

El modelo de lenguaje no calcula ni inventa precios. Su función es presentar y explicar la información devuelta por el sistema comercial.

### Motor de comparación

Después de eliminar las alternativas inválidas, un componente de reglas compara las opciones restantes considerando afinidad con la ocasión, capacidad, disponibilidad, preferencias y presupuesto.

La puntuación se calcula con criterios definidos por el negocio. El agente puede explicar el resultado, pero no puede modificar los pesos ni favorecer una opción por decisión propia.

### Conexión con preferencias autorizadas

El agente puede consultar preferencias guardadas anteriormente, como “prefiero opciones sencillas” o “normalmente busco alternativas económicas”.

Solo puede guardar una nueva preferencia después de explicarlo y obtener el consentimiento explícito del usuario.

### Conexión con atención humana

Cuando el caso supera su autonomía, el agente se conecta con el sistema de atención comercial o CRM para crear una solicitud para un asesor.

La derivación debe incluir un resumen de lo conversado, los datos recopilados, las validaciones realizadas, la alternativa evaluada y el motivo exacto por el que se requiere intervención humana.
